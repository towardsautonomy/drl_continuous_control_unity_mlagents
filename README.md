...
# DDPG for Continuous Controls - Training ML Agent within Unity framework 
...
The agent is not able to learn anything with parameters as suggested by the DDPG network.
...
![](logs/reacher_ddpg_orig/plot.png)
